...
insert into language (language_code,language_name) values ('en', 'English');
insert into language (language_code,language_name) values ('ru', 'Rusnya');
insert into language (language_code,language_name) values ('fr', 'French');